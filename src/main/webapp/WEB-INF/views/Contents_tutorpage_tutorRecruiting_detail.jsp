...
/* 삭제기능 정비해야 됨 */
	$(function()
	{
		$(".deleteBtn").click(function()
		{
					...
					{
						$(location).attr("href", "tutor_tutorpage_tutorrecruiting_drop?TUTORING_TUTOR_ID="+${detail[0].TUTORING_TUTOR_ID });
					}
		...
		<div class="middleTab">
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link active"
					href="tutor_tutorpage_tutorrecruiting_detail?TUTORING_TUTOR_ID=${detail[0].TUTORING_TUTOR_ID}">상세정보</a></li>
				<li class="nav-item "><a class="nav-link"
					href="tutor_tutorpage_tutorrecruiting_tuteemanage?TUTORING_TUTOR_ID=${detail[0].TUTORING_TUTOR_ID}">튜티관리</a></li>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-9">
					<div class="media mb-4">
						<img class="${review.PROF_PATH }" style="border-radius: 100%;">
						<!-- 댓글 프로필사진 -->
