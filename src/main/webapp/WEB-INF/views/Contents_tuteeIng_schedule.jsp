	...
	<div class="middle">
		...
		<div class="middleTab">
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link" href="tutee_tuteeingDetail?TUTORING_TUTOR_ID=${detail.TUTORING_TUTOR_ID }">상세정보</a></li>
				<li class="nav-item"><a class="nav-link" href="#profile">튜터링게시판</a></li>
				<li class="nav-item"><a class="nav-link active" href="mypage_ing_schedule?TUTORING_TUTOR_ID=${detail.TUTORING_TUTOR_ID }">일정정보</a></li>
				<li style="padding-left: 500px;"><button type="button"
						class="btn btn-outline-danger btn-sm">중도포기</button></li>
			</ul>
		</div>
		<!-- 탭 END -->
		...
		<div class="TutoringContents">
			...
			<c:forEach var="sc" items="${schedule }">
				...
				<div class="card border-primary mb-3" style="max-width: 54rem;">
					...
					<div class="card-body">
						<h4 class="card-title">${sc.SCH_TAKE}회차 튜터링</h4>
