...
<div id="contents" class="col-md-12">
	...
	<div class="classlists">
		...
		<c:if test="${empty afterList }">
		
			현재 수강 신청한 튜터링이 없습니다.
		
		</c:if>

		<c:forEach var="list" items="${afterList }">
		<!-- //한 줄// -->
		<div>
			<!-- 튜터링 사진 -->
			<div class="listimg">
			...
			<div class="listcontents">
				<!-- 튜터링 이름 -->
				<div class="listname">
					<a href="tutee_aftertutoringdetail?TUTORING_TUTOR_ID=${list.TUTORING_TUTOR_ID}" ><span>${list.TITLE }</span></a>
				</div>
