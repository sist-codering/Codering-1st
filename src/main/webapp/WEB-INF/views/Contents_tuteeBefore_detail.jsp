...
<div id="contents">
	...
	<div class="top">
		...
		<div class="TutoringPhoto">
			<img src="${BeforeTutoringDetail.THUMBNAIL_PATH }">
		</div>

		<!-- 튜터링 이름 -->
		<div class="TutoringName1">
			<span>${BeforeTutoringDetail.TITLE }</span>
		</div>
		...
		<div class="TutoringName2">
			<div class="TutoringName2_1">
				<img width="50px" height="40px"
					src="${BeforeTutoringDetail.TUTOR_PROF }"
					style="border-radius: 100%;">
			</div>
			<div class="TutoringName2_2" style="position: relative; left: 150px;">
				${BeforeTutoringDetail.COUNT_TUTORING}명</div>
			<br>
			<div class="TutoringName2_2"
				style="position: relative; left: 100px; padding: 20px;">시작일 :
				${BeforeTutoringDetail.START_DATE }</div>
			<br>
			<br>
			<div class="TutoringName2_2"
				style="padding: 20px; position: relative; right: 80px;">${BeforeTutoringDetail.WEEK_PERIOD }주
				과정</div>
		</div>
	...
	<div class="middle">
		...
		<div class="middleTab">
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link active" href="tutee_beforetutoringdetail?TUTORING_TUTOR_ID=${BeforeTutoringDetail.TUTORING_TUTOR_ID }">상세정보</a></li>
				<li class="nav-item"><a class="nav-link" href="">튜터링게시판</a></li>
				<li class="nav-item"><a class="nav-link" href="mypage_before_schedule?TUTORING_TUTOR_ID=${BeforeTutoringDetail.TUTORING_TUTOR_ID }">일정정보</a></li>
				<li class="nav-item"><a class="nav-link" href="mypage_before_review?TUTORING_TUTOR_ID=${BeforeTutoringDetail.TUTORING_TUTOR_ID }">후기</a></li>
			</ul>
		</div>
		<!-- 탭 END -->
		...
		<div class="TutoringContents">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-9">
					<p class="subcontent">${BeforeTutoringDetail.INTRO }</p>
				...
				<div class="col-xs-12 col-sm-9 subcontent list-unstyled">
					<ul>
						<li><span class="fa fa-map-pin"></span>&nbsp;&nbsp;&nbsp;&nbsp;
							지역 : ${BeforeTutoringDetail.REG_NAME }</li>
						<li><span class="far fa-calendar-alt"></span>&nbsp;&nbsp;&nbsp;&nbsp;2019.
							시작일, 기간 : ${BeforeTutoringDetail.START_DATE },
							${AfterTutoringDetail.WEEK_PERIOD }</li>
						<li><span class="far fa-clock"></span>&nbsp;&nbsp;&nbsp;&nbsp;매주
							요일, 시간 : ${BeforeTutoringDetail.WEEK_NAME },
							${AfterTutoringDetail.START_TIME }</li>
						<li><span class="fa fa-user"></span>&nbsp;&nbsp;&nbsp;&nbsp;6명
							인원 : ${BeforeTutoringDetail.COUNT_TUTORING }</li>
						<li><span class="fa fa-tag"></span>&nbsp;&nbsp;&nbsp;&nbsp;350000
							금액 : ${BeforeTutoringDetail.ENTRY_COST }</li>
					</ul>
					<br>
					<!-- 지도 api 넣을 부분 (임시 img) -->
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-9">
					...
					<p class="subcontent">${BeforeTutoringDetail.TUTOR_INTRO }</p>
				</div>
			</div>
			<!-- Post Content.row -->
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-9">
					<div class="media mb-4">
						<img width="50px" height="40px"
							src="${BeforeTutoringDetail.TUTEE_PROF_PATH }"
							style="border-radius: 100%;">
						<!-- 댓글 프로필사진 -->
						<div class="media-body subcontent">
							<div class="mt-0">${BeforeTutoringDetail.NICKNAME }</div>
							<footer class="blockquote-footer">
								<cite title="Source Title">${BeforeTutoringDetail.WRITEDATE }
									작성</cite>
							</footer>
							<br>${BeforeTutoringDetail.CONTENT }
						</div>
					</div>
					<a href="profile_tutor?TUTOR_ID=${BeforeTutoringDetail.TUTOR_ID}"><button
					...
					<form>
						<div class="form-group">
							<textarea class="form-control subcontent" rows="3"
								placeholder="문의 내용을 입력하세요." disabled="disabled"></textarea>
						</div>
						<button type="button" class="btn btn-primary disabled float-right">등록</button>
					</form>
				</div>
			</div>
						...
						<div class="media mb-4" style="position: relative; left: 100px;">
							<div class="media-body subcontent">
								<div class="media mt-4 tutor-reply">
									<img width="20px" height="15px" src="${tutoringfaq.PROF_PATH }"
										style="border-radius: 100%;">
									<!-- 댓글 프로필사진 -->
									<div class="media-body subcontent">
