...
<title>mypage_tutee_writtenReply</title>
...
<script src="<%=cp%>/https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
	...
	<div>
		...
		<div id="container">
			...
			<div id="contents" class="col-md-3">
				<c:import url="Contents_tutee_writtenReply.jsp"></c:import>
			</div>
