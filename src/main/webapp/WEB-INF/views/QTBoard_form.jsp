...
<body>
	...
	<div class="flex-container">
		...
		<div class="flex-container-body">
			<form name="boardForm" method="post" action="<%=cp%>/qtboard_created" onsubmit="return submitContents(this);" enctype="multipart/form-data">
			<div class="flex-item">
				<!-- 본문 상단 : top-content -->
							...
							<div class="divTableRow">
								...
								<div class="divTableCell">
									<select class="block CellRadius" name="HEAD_ID">
										<option value="1" selected="selected">질문</option>
										<option value="2">팁</option>
										<option value="3">자유</option>
									</select>
									<div class=" styleSubject" >
										<input type="text" maxlength="50" class="CellRadius" id="title" name="TITLE">
									</div>
								</div>
								<!-- td -->
							</div>
...
<!-- 								<div class="filebox">
				...
				<div class="bottom-content-center">
					...
					<div style="margin: 20px 20px 20px 0;">
						...
						onclick="javascript:location.href='<%=cp%>/qtboard_list';">목록으로</button>
					</div>

					<!-- 글쓰기 버튼 -->
					<div style="margin: 20px 0 20px 0;">
						<button type="submit" class="btn QT-btn-purple">글쓰기</button>
					</div>
