...
<body>
	...
	<div class="container">
		...
		<div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
			...
			<div align="center" class="carousel-inner" role="listbox" style="height: 350px; padding: 40px;">
				<div class="carousel-item active">
					<img class="d-block img-fluid" src="images/banner.jpg" alt="First slide">
				</div>
				<div class="carousel-item">
					<img class="d-block img-fluid" src="images/banner4.jpg" alt="Second slide">
				</div>
				<div class="carousel-item">
					<img class="d-block img-fluid" src="images/banner5.jpg" alt="Third slide">
				</div>
			</div>
		...
		<div style="padding: 0px 0px 10px 0px;">
			<span style="font-family: Malgun Gothic; font-weight: bold; font-size: 20px;">인기 튜터링</span> 
				<a href="tutor_TutoringSearchList">
					<span style="font-family: Malgun Gothic; font-weight: bold; float: right; padding: 8px 0px 0px 0px;">전체보기</span>
				</a>
		</div>
					...
					<div class="card h-100">
						...
						<div class="card-body" style="margin-top: 15%;">
							...
							<p class="card-text" style="text-align: center; font-size: 17px;">${pt.REG_NAME }
								<br>${pt.selectLangLv }
								<br>
								<span style="color: #FE642E; font-weight: bold;">${pt.ENTRY_COST }</span>
								<span style="color: gray; font-weight: bold; font-size: 13px;">	/ ${pt.WEEK }주</span>
							</p>
						</div>
		...
		<!-- 튜터링 목록들 바로가기 -->
		<div style="position: relative; left: 35px; padding: 80px 0px 140px 0px;">
			<img src="<%=cp %>/images/20.png" style="padding: 0px 0px 0px 40px; width: 500px; height: 280px;">
			<span style="color: white; text-align: center; font-family: Noto Sans KR; font-size: 40px; position: absolute; left: 130px; top: 160px;">
				튜터가 개설한<br>${selectTutorCount }개의 튜터링
			</span> 
			
			<img src="<%=cp %>/images/21.png" style="padding: 0px 0px 0px 50px; width: 500px; height: 280px;">
			<span style="color: white; text-align: center; font-family: Noto Sans KR; font-size: 40px; position: absolute; left: 640px; top: 160px;">
		...
		<!-- 신규 튜터링 리스트 -->
		<div style="padding: 0px 0px 10px 0px;">
			<span style="font-family: Malgun Gothic; font-weight: bold; font-size: 20px;">신규 튜터링</span>
			<a href="tutor_TutoringSearchList">
				<span style="font-family: Malgun Gothic; font-weight: bold; float: right; padding: 8px 0px 0px 0px;">전체보기</span>
			</a>
		</div>
					...
					<div class="card h-100">
						...
						<div class="card-body">
							...
							<p class="card-text" style="text-align: center; font-size: 17px;">${nt.REG_NAME }
								...
								<span style="color: gray; font-weight: bold; font-size: 13px;">/ ${nt.WEEK }주 </span>
							</p>
						</div>
	...
	<div style="padding: 0px 0px 200px 0px;">
		...
		<div>
			...
			<div style="float: left; padding: 20px 0px 0px 20px;">
				<strong>단계별 튜터링</strong> 
				<br> 초급~고급까지 본인의 수준에 맞는 다양한 레벨의 튜터링에 참여할 수 있어요!
			</div>
		</div>
		<!-- 코드링 특장점 설명 첫 번째 End-->
		...
		<div>
			...
			<div style="float: left; padding: 20px 0px 0px 20px;">
				<strong>튜터링 커뮤니케이션 지원</strong> 
				<br> 튜터링이 시작되면 해당 튜터링의 커뮤니케이션을 코드링에서 도와드려요.
			</div>
		</div>
